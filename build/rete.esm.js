...
function (_Emitter) {
  ...
  function Area(container, emitter) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_fragment", document.createDocumentFragment());

    _defineProperty(_assertThisInitialized(_this), "_appendFlushTimeout", 1);
  ...
  _createClass(Area, [{
    ...
    value: function appendChild(el) {
      ...
      this._appendFlushTimeout = setTimeout(function () {
        _this2.el.appendChild(_this2._fragment);

        _this2.trigger('rendered', _this2.el);
      });
    }
  }, {
    key: "removeChild",
...
function (_Emitter) {
  ...
  function NodeView(node, component, emitter) {
    ...
    new Drag(_this.el, _this.onTranslate.bind(_assertThisInitialized(_this)), _this.onSelect.bind(_assertThisInitialized(_this)), function () {
  ...
  _createClass(Recursion, [{
    ...
    value: function extractInputNodes(node) {
      ...
      return Object.keys(node.inputs).reduce(function (a, key) {
        ...
        return [].concat(_toConsumableArray(a), _toConsumableArray((connections || []).reduce(function (b, c) {
